...
BACKGROUND_IMAGE_DIR  = r"E:\synth_data\real_background"  # folder containing grayscale fibre images
...
#defect appearance
DEFECT_CONTRAST_SCALE = 0.45  # lower = darker defects; scales the inverted-mean defect value
